...
exports.detectLanguage = exports.t = exports.I18n = void 0;
/**
...
class I18n {
     ...
     */
    static getTranslationInEnglish(key) {
        const keys = key.split('.');
     ...
     */
    static addTranslations(lang, newTranslations) {
        translations[lang] = {
            ...translations[lang],
            ...newTranslations
        };
...
exports.detectLanguage = I18n.detectLanguage.bind(I18n);
