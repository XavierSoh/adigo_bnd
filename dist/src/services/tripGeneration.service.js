...
exports.TripGenerationService = void 0;
...
class TripGenerationService {
    async generateTripsForPeriod(startDate, endDate, userId) {
    ...
    async generateTripInstances(trip, startDate, endDate) {
    ...
    async createTripInstance(trip, date) {
    ...
    async getBusCapacity(busId) {
        const bus = await pgdb_1.default.oneOrNone(`
            SELECT capacity FROM ${tbl.kBus} WHERE id = $1 AND is_deleted = false
        `, [busId]);
        return bus?.capacity || 0;
    }
    async logGeneration(startDate, endDate, count, userId) {
        await pgdb_1.default.none(`
    ...
    async cleanupGeneratedTrips(startDate, endDate) {
        await pgdb_1.default.none(`
...
exports.TripGenerationService = TripGenerationService;
