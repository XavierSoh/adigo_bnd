...
async function initChatData() {
    try {
        ...
        const existingQuickReplies = await chat_repository_1.ChatRepository.getActiveQuickReplies();
        ...
        const existingAIResponses = await chat_repository_1.ChatRepository.getActiveAIResponses();
 ...
 */
async function createDefaultQuickReplies() {
    ...
    for (const quickReply of defaultQuickReplies) {
        try {
            await chat_repository_1.ChatRepository.createQuickReply(quickReply);
 ...
 */
async function createDefaultAIResponses() {
    ...
    for (const aiResponse of defaultAIResponses) {
        try {
            await chat_repository_1.ChatRepository.createAIResponse(aiResponse);
