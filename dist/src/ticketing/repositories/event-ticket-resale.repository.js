...
exports.EventTicketResaleRepository = void 0;
 ...
 */
class EventTicketResaleRepository {
    /**
     * Create a new ticket resale listing
     */
    static async create(data, created_by) {
        try {
            // Verify ticket exists and is resellable
            const ticket = await pgdb_1.default.oneOrNone(`
                SELECT
                    id,
                    status,
                    customer_id,
            ...
            const existingListing = await pgdb_1.default.oneOrNone(`
                SELECT id, status
            ...
            const resale = await pgdb_1.default.one(`
    ...
    static async findById(id) {
        try {
            const resale = await pgdb_1.default.oneOrNone(`
                SELECT
                    r.*,
                    json_build_object(
                        'id', e.id,
     ...
     * Find by resale code
     */
    static async findByResaleCode(resaleCode) {
        try {
            const resale = await pgdb_1.default.oneOrNone(`
                SELECT
                    r.*,
    ...
    static async search(params) {
        try {
            ...
            const resales = await pgdb_1.default.any(`
                SELECT
                    r.*,
                    json_build_object(
                        'id', e.id,
     ...
     */
    static async findActiveByEvent(eventId) {
        try {
            const resales = await pgdb_1.default.any(`
                SELECT
                    r.*,
    ...
    static async purchase(purchaseData) {
        try {
            ...
            const buyer = await pgdb_1.default.oneOrNone('SELECT wallet_balance FROM customer WHERE id = $1', [purchaseData.buyer_id]);
            ...
            // Start transaction
            await pgdb_1.default.tx(async (t) => {
                // Deduct from buyer
                await t.none(`
                    UPDATE customer
     ...
     */
    static async cancel(id, sellerId, reason) {
        try {
...
exports.EventTicketResaleRepository = EventTicketResaleRepository;
