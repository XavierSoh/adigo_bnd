...
class ExportService {
     ...
     */
    static async exportToExcel(data, columns, sheetName = 'Export') {
     ...
     */
    static formatUsersForExport(users) {
     ...
     */
    static formatEventsForExport(events) {
     ...
     */
    static formatTicketsForExport(tickets) {
