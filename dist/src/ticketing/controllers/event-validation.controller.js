...
exports.EventValidationController = void 0;
const i18n_1 = require("../../utils/i18n");
const pgdb_1 = __importDefault(require("../../config/pgdb"));
class EventValidationController {
    /**
    ...
    static async getPendingEvents(req, res) {
        try {
            ...
            res.status(200).json({
                status: true,
                message: i18n_1.I18n.t('events_retrieved', lang),
    ...
    static async approveEvent(req, res) {
        try {
            ...
            const result = await pgdb_1.default.one(`
                UPDATE event
            ...
            res.status(200).json({
                status: true,
                message: i18n_1.I18n.t('event_approved', lang),
                body: result,
                code: 200
            });
        }
    ...
    static async rejectEvent(req, res) {
        try {
            ...
            res.status(200).json({
                status: true,
                message: i18n_1.I18n.t('event_rejected', lang),
                body: result,
                code: 200
            });
        }
     ...
     */
    static async getPendingOrganizers(req, res) {
        try {
            const lang = req.lang || 'en';
            const organizers = await pgdb_1.default.any(`
                SELECT
                    o.*,
                    json_build_object(
                        'id', c.id,
            ...
            res.status(200).json({
                status: true,
                message: i18n_1.I18n.t('organizers_retrieved', lang),
     ...
     */
    static async verifyOrganizer(req, res) {
        try {
            const lang = req.lang || 'en';
            ...
            res.status(200).json({
                status: true,
                message: i18n_1.I18n.t('organizer_verified', lang),
                body: result,
                code: 200
            });
        }
     ...
     */
    static async getEventsStats(req, res) {
        try {
            const lang = req.lang || 'en';
...
exports.EventValidationController = EventValidationController;
