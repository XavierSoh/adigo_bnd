...
export interface EventOrganizer {
    id?: number;
    customer_id?: number;              // Link to customer account
    ...
    // Legal Documents
    rccm_number?: string;
    rccm_document?: string;            // Path to uploaded file
    id_card_type?: string;             // 'national_id' | 'passport'
    id_card_number?: string;
    id_card_document?: string;         // Path to uploaded file
    proof_of_venue?: string;           // Path to uploaded file
